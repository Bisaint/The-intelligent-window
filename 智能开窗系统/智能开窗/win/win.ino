...
String TOPIC = "WINSTA"; 
//单片机LED引脚值
const int LED_Pin0 = 14;//继电器
const int LED_Pin1 = 12; //继电器
const int LED_Pin2 = 13; //继电器
const int LED_Pin3 = 15; //继电器

//主题名字，可在控制台新建
String TOPIC2  = "WINDOW1";  //用于led控制的主题
...
// read without samples.
   ...
   float hic = dht.computeHeatIndex(t, h, false);
      ...
      */
      String upstr = "";
      upstr = "cmd=2&uid="+UID+"&topic="+TOPIC+"&msg=#"+my_led_status+"#"+t+"#"+h+"#"+f+"#"+hif+"#"+hic+"#"+"\r\n";
